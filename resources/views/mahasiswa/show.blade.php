...
<section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item">Show Mahasiswa</div>
      </div>
    </div>

    <div class="section-body">
      <h2 class="section-title">Show Mahasiswa</h2>
      <p class="section-lead">
        On this page you can Show a Mahasiswa and fill in all fields.
      </p>
        @if (count($errors) > 0)
