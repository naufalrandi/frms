    ...
    <section class="section">
      <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
          ...
          <div class="breadcrumb-item">All Alumni</div>
        </div>
      </div>
                  ...
                  <table class="table table-striped" id="alumni">
                    ...
                    <td>
                        <div class="table-links">
                            <a class="btn btn-info btn-sm" href="{{ route('alumni.show',$alumni->id) }}">Show</a>
                            <div class="bullet"></div>
                            <a class="btn btn-primary btn-sm" href="{{ route('alumni.edit',$alumni->id) }}">Edit</a>
                            <div class="bullet"></div>
